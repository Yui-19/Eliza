...
PRO_STRINGS = [
    ...
    "`Proness label : 6969696969`",
    "`Itna pro bnda dekh liya bc , ab to mrna hoga`",
    "`You is pro but I is ur dad , kick`",
    "`NOOB NIBBA TRYING TO BE FAMOUS KICK`",
    "`Sometimes one middle finger isn't enough to let someone know how you feel ? That's why you have two hands`",
    "`Some nibbas need to open their small minds instead of their big mouths`",
    "`YOU DON'T KNOW ME SO STAY AWAY LAWDE`",
    "`Ky ky hn ? Phir maar nhi khyega tu ?`",
    "`Zikr jinka hota h gaaliyo me voh bsdk aaj pya gya naaliyo me`",
]
CHU_STRINGS = [
...
SLAP_TEMPLATES = [
    ...
    "{user1} sent {victim} to dev or null",
