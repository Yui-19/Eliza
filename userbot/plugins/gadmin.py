...
@catub.cat_cmd(
    ...
    info={
        ...
        "description": "It doesn't change user permissions but will delete all messages sent by him in the groups where you are admin including in private messages",
