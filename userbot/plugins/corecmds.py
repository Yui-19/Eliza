...
@catub.cat_cmd(
    ...
    info={
        ...
        "description": "You can load this unloaded plugin by restarting or using {tr} load command , useful for cases like seting notes in rose bot ({tr} unload markdown )",
